...
// --- 1. LOGIKA PAGINATION ---
$limit = 3; // Hanya 3 konten per halaman
...
$sql = "SELECT * FROM courses ORDER BY created_at DESC LIMIT $limit OFFSET $offset";
...
<head>
    ...
    <title>Related Courses - EduNext</title>
...
<body>
    ...
    <div class="resource-container">
        ...
        <div class="card">
            ...
            <a href="<?php echo $row['link_url']; ?>" class="btn-action">Visit</a>
        </div>
        <?php endwhile; ?>
    </div>
